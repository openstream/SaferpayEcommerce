...
class Saferpay_Ecommerce_Block_Form extends Mage_Payment_Block_Form
{
	protected function _construct()
	{
		parent::_construct();
		$this->setTemplate('saferpay/ecommerce/form.phtml');
	}
	...
	public function getPaymentImageSrc($methodCode)
	{
		...
		if (file_exists($imageFilename . '.png')) {
			return $this->getSkinUrl('images/saferpay/ecommerce/' . $methodCode . '.png');
		} else if (file_exists($imageFilename . '.gif')) {
			return $this->getSkinUrl('images/saferpay/ecommerce/' . $methodCode . '.gif');
		}
